...
class User extends Authenticatable implements JWTSubject
{
    ...
    {
        return $this->attributes['lessor'] = ($value === true || $value === 'on' ? 1 : 0);
    }

    public function setLesseeAttribute($value)
    {
        return $this->attributes['lessee'] = ($value === true || $value === 'on' ? 1 : 0);
    }

    public function setDocumentAttribute($value)
    {
        return $this->attributes['document'] = $this->clearField($value);
    }

    public function getDocumentAttribute($value)
    {
        return $this->formatSringToDocument($value);
    }

    public function setDateOfBirthAttribute($value)
    {
        return $this->attributes['date_of_birth'] = $this->convertStringToDate($value);
    }

    public function getDateOfBirthAttribute($value)
    {
        return $this->formatStringtoDate($value);
    }

    public function setIncomeAttribute($value)
    {
        return $this->attributes['income'] = floatval($this->convertStringToDouble($value));
    }

    public function getIncomeAttribute($value)
    {
        return $this->formatFloattoCurrency($value);
    }
    ...
    {
        return $this->attributes['telephone'] = $this->clearField($value);
    }

    public function setCellAttribute($value)
    {
        return $this->attributes['cell'] = $this->clearField($value);
    }
    ...
    {
        return $this->attributes['spouse_document'] = $this->clearField($value);
    }
    ...
    {
        return $this->attributes['spouse_date_of_birth'] = $this->convertStringToDate($value);
    }
    ...
    {
        return $this->attributes['spouse_income'] = floatval($this->convertStringToDouble($value));
    }
    ...
    {
        return $this->attributes['admin'] = ($value === true || $value === 'on' ? 1 : 0);
    }

    public function setClientAttribute($value)
    {
        return $this->attributes['client'] = ($value === true || $value === 'on' ? 1 : 0);
    }
    ...
    private function formatSringToDocument(?string $param)
    {
        return substr($param, '0', '3') . '.' . substr($param, '3', '3') . '.' . substr($param, '6', '3') . '-' . substr($param, '9', '2');
    }

    private function formatStringtoDate(?string $param)
    {
        return date('d/m/Y', strtotime($param));
    }

    private function formatFloattoCurrency(?float $param)
    {
