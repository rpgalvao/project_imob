...
class Contract extends Model
{
    ...
    public function scopeContractsPending($query)
    {
        return $query->where('status', 'pending');
    }

    public function scopeContractsActive($query)
    {
        return $query->where('status', 'active');
    }

    public function scopeContractsCancelled($query)
    {
        return $query->where('status', 'cancelled');
    }

    public function scopeContractsFinished($query)
    {
    ...
    public function terms()
    {
        ...
        $terms[] = "<p style='text-align: center;'>CONTRATO DE {$parameters['purpouse']} DE IMÓVEL - Nº: {$this->id}</p>";
        ...
        $terms[] = "<p>São Paulo, " . date('d/m/Y') . ".</p>";
