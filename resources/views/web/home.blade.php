            ...
            <div class="row">
                <form action="" class="form-inline w-100">
                    ...
                    <div class="form-group col-12 col-sm-6 mt-sm-2 col-lg-3 mt-lg-0">
                        ...
                        <select class="selectpicker" name="filter_neighborhood" id="neighborhood" data-index="4"
                            ...
                            <article class="card main_properties_item">
                                ...
                                <div class="card-body">
                                    <h2 style="min-height: 150px;"><a
                                            href="{{ route('web.buyProperty', ['slug' => $property->slug]) }}"
                    ...
                    @foreach($propertiesForRent as $property)
                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                            <article class="card main_properties_item">
                                ...
                                <div class="card-body">
                                    <h2 style="min-height: 150px;"><a
                                            href="{{ route('web.rentProperty', ['slug' => $property->slug]) }}"
                                            class="text-front">{{ $property->title }}</a>
                                    </h2>
                                    <p class="main_properties_item_category">{{ $property->category }}</p>
                                    <p class="main_properties_item_type">{{ $property->type }}
