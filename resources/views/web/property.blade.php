            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4">
                        <a href="https://api.whatsapp.com/send?phone=55+11+963013839&text=Olá, gostaria de mais informações sobre o imóvel."
                           target="_blank" class="btn btn-outline-success btn-lg btn-block icon-whatsapp mb-3">Converse
                            com o
                            Corretor!
                        </a>
                        ...
                        <div class="main_property_contact">
                            ...
                            <form action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="message" id="message" cols="30" rows="5" class="form-control">Quero ter mais informações sobre esse imóvel. {{ $property->category }}, {{ $property->type }}, {{ $property->neighborhood }}, {{ $property->city }}! (#{{ $property->id }})</textarea>
                                </div>

                                <div class="form-group">
                                    <button class="btn btn-block btn-front">Enviar</button>
                                    <p class="text-center text-front mb-0 mt-4 font-weight-bold">(11) 4321-1234</p>
                                </div>
                            </form>
                        </div>
