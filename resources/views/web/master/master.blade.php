...
<section class="main_footer bg-light"
         style="background: url({{ url(asset('frontend/assets/images/footer.png')) }}) repeat-x bottom center; background-size: 10%;">
...
<script src="{{ url(mix('frontend/assets/js/libs/lightbox.js')) }}"></script>
