            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li class="separator icon-angle-right icon-notext"></li>
                        <li><a class="text-orange">Cadastrar Contrato</a></li>
                    </ul>
                </nav>
            </div>
        </header>
                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <select name="status" class="select2">
                                        <option value="">Selecione o status desse contrato</option>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <input type="tel" name="sale_price" class="mask-money"
                                                   placeholder="Valor de Venda" {{ (old('sale_price') != true ? 'disabled' : '') }}/>
                                        </label>

                                        <label class="label">
                                            <span class="legend">Valor de Locação:</span>
                                            <input type="text" name="rent_price" class="mask-money"
                                                   placeholder="Valor de Locação" {{ (old('rent_price') != true ? 'disabled' : '') }}/>
                                        </label>
                                    </div>
