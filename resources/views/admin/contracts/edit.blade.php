            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li class="separator icon-angle-right icon-notext"></li>
                        <li><a class="text-orange">Editar Contrato</a></li>
                    </ul>
                </nav>
            </div>
        </header>
                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <select name="status" class="select2">
                                        ...
                                        <option value="finished" {{ old('status') === 'finished' ? 'selected' : ($contract->status === 'finished' ? 'selected' : '') }}>Finalizado</option>
                                        <option value="cancelled" {{ old('status') === 'cancelled' ? 'selected' : ($contract->status === 'cancelled' ? 'selected' : '') }}>Cancelado</option>
                                    </select>
                                </label>
                            </div>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select class="select2" name="owner"
                                                    data-action="{{ route('admin.contracts.getOwnerInfo') }}">
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select name="acquirer" class="select2"
                                                    data-action="{{ route('admin.contracts.getAcquirerInfo') }}">
                                ...
                                <div class="app_collapse_content">
                                    <label class="label">
                                        ...
                                        <select name="property" class="select2"
                                                data-action="{{ route('admin.contracts.getPropertyInfo') }}">
...
@section('js')
    <script>
        $(function () {
            ...
            function setAcquirerField(response) {
                // Spouse
            ...
            function setPropertyField(response) {
