                    ...
                    <div class="nav_tabs_content">
                        <div id="data">
                            <div class="label_gc">
                                ...
                                <label class="label">
                                    <input type="checkbox"
                                           name="lessor" {{ old('lessor') == true || old('lessor') == 'on' ? 'checked' : ($user->lessor == true ? 'checked' : '')}}><span>Locatário</span>
                                </label>

                                <label class="label">
                                    <input type="checkbox"
                                           name="lessee" {{ old('lessee') == true || old('lessee') == 'on' ? 'checked' : ($user->lessee == true ? 'checked' : '')}}><span>Locador</span>
                                </label>
                            </div>
                        ...
                        <div id="management" class="d-none">
                            <div class="label_gc">
                                ...
                                <label class="label">
                                    <input type="checkbox"
                                           name="admin" {{ old('admin') == true || old('admin') == 'on' ? 'checked' : ($user->admin == true ? 'checked' : '')}}><span>Administrativo</span>
                                </label>
