            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li class="separator icon-angle-right icon-notext"></li>
                        <li><a class="text-orange">Cadastrar Imóvel</a></li>
                    </ul>
                </nav>
                                ...
                                <label class="label">
                                    ...
                                    <select name="type" class="select2">
                                        ...
                                        <optgroup label="Terreno">
                                            <option value="Lote" {{ (old('type') == 'Lote' ? 'selected' : '') }}>Lote</option>
                                        </optgroup>
                                    </select>
                                </label>
                            </div>
                                ...
                                <div class="app_collapse_content d-none">
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <input type="tel" name="sale_price" class="mask-money" value="{{ old('sale_price') }}" disabled/>
                                        </label>

                                        <label class="label">
                                            <span class="legend">Valor de Locação:</span>
                                            <input type="tel" name="rent_price" class="mask-money" value="{{ old('rent_price') }}" disabled/>
                                        </label>
                                    </div>
