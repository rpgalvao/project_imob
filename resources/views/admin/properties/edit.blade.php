            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li class="separator icon-angle-right icon-notext"></li>
                        <li><a class="text-orange">Editar Imóvel</a></li>
                    </ul>
                </nav>
                        ...
                        <div id="data">
                                ...
                                <label class="label">
                                    ...
                                    <select name="type" class="select2">
                                        ...
                                        <optgroup label="Terreno">
                                            <option
                                                value="Lote" {{ (old('type') == 'Lote' ? 'selected' : ($property->type == 'Lote' ? 'selected' : '')) }}>
                                                Lote
                                            </option>
                                        </optgroup>
                                    </select>
                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <select name="status" class="select2" {{ ($property->status == false ? 'disabled' : '') }}>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <input type="tel" name="sale_price" class="mask-money"
                                                   value="{{ old('sale_price') ?? $property->sale_price }}" {{ (old('sale') == 'on' || old('sale') == true ? '' : ($property->sale == true ? '' : 'disabled')) }}/>
                                        </label>

                                        <label class="label">
                                            <span class="legend">Valor de Locação:</span>
                                            <input type="tel" name="rent_price" class="mask-money"
                                                   value="{{ old('rent_price') ?? $property->rent_price }}" {{ (old('rent') == 'on' || old('rent') == true ? '' : ($property->rent == true ? '' : 'disabled')) }}/>
                                        </label>
                                    </div>
                                    ...
                                    <div class="property_image_item">
                                        ...
                                        <div class="property_image_actions">
                                            <a href="javascript:void(0)"
                                               ...
                                               data-action="{{ route('admin.properties.setCoverImage', ['image' => $image->id]) }}"></a>
                                            <a href="javascript:void(0)"
                                               class="btn btn-red btn-small icon-times icon-notext image-remove"
                                               data-action="{{ route('admin.properties.removeImage', ['image' => $image->id]) }}"></a>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
