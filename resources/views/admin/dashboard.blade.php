            ...
            <div class="dash_content_app_box">
                <section class="app_dash_home_stats">
                    ...
                    <article class="users radius">
                        ...
                        <p><b>Cancelados:</b> {{ $contractsCancelled }}</p>
                        <p><b>Finalizados:</b> {{ $contractsFinished }}</p>
                            ...
                            @foreach($properties as $property)
                                <div class="realty_list_item mb-3">
                                    ...
                                    <div class="realty_list_item_content">
                                        <h4>#{{ $property->id }} {{ $property->category }} - {{ $property->type }} <span
                                                class="text-orange ml-5">{{ ($property->status === 0 ? ' Indisponível' : '') }}</span>
                                        </h4>
