...
<div class="dash_login">
    <div class="dash_login_left">
        <article class="dash_login_left_box">
            ...
            <footer>
                <p>Desenvolvido por <a href="https://www.rpgsistemas.com.br" target="_blank">www.<b>@rpg Sistemas</b>.com.br</a></p>
                <p>&copy; <?= date("Y"); ?> - Todos os Direitos Reservados</p>
                <p class="dash_login_left_box_support">
                    <a target="_blank"
                       class="icon-whatsapp transition text-green"
                       href="https://api.whatsapp.com/send?phone=55+11+963013839&text=Olá, preciso de ajuda com o login."
